...
# Import DBSCAN functionality from dedicated module
from utils.gpu_dbscan import apply_dbscan_clustering_gpu

# Define public API
__all__ = [
    # ... existing functions ...
    "apply_dbscan_clustering_gpu",  # Re-exported from gpu_dbscan
]
