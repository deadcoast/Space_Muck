...
class CrewManagementSystem:
    ...
    def get_station_crew(self, station: str) -> List[CrewMember]:
        ...
        return [self.crew_members[crew_id] for crew_id in self.station_assignments[station]]
    ...
    def get_all_station_efficiencies(self) -> Dict[str, float]:
        ...
        """
        return {station: self.get_station_efficiency(station) for station in STATION_TYPES}
    ...
    def _process_crew_work_shift(self, crew_id: str, crew_member: CrewMember, 
                               hours_passed: float, results: Dict[str, List[Dict[str, Any]]]) -> None:
    ...
    def _track_fatigue_increase(self, crew_id: str, crew_member: CrewMember, 
                              work_result: Dict[str, Any], results: Dict[str, List[Dict[str, Any]]]) -> None:
    ...
    def _track_morale_decrease(self, crew_id: str, crew_member: CrewMember, 
                             work_result: Dict[str, Any], results: Dict[str, List[Dict[str, Any]]]) -> None:
    ...
    def _track_experience_gain(self, crew_id: str, crew_member: CrewMember, 
                             work_result: Dict[str, Any], results: Dict[str, List[Dict[str, Any]]]) -> None:
    ...
    def _track_level_up(self, crew_id: str, crew_member: CrewMember, 
                       work_result: Dict[str, Any], results: Dict[str, List[Dict[str, Any]]]) -> None:
    ...
    def rest_crew(self, crew_id: Optional[str] = None, hours: int = 8) -> Dict[str, Any]:
    ...
    def _rest_specific_crew(self, crew_id: str, hours: int, results: Dict[str, List[Dict[str, Any]]]) -> Dict[str, Any]:
    ...
    def _rest_all_unassigned_crew(self, hours: int, results: Dict[str, List[Dict[str, Any]]]) -> None:
    ...
    def _update_rest_results(self, results: Dict[str, List[Dict[str, Any]]], 
                           crew_id: str, crew_member: CrewMember, 
                           rest_result: Dict[str, Any]) -> None:
    ...
    def recruit_random_crew(self, count: int = 1) -> Dict[str, Any]:
        ...
        if results["recruited"]:
            ...
            results["message"] = f"Recruited {len(results['recruited'])} new crew members: {names}"
        else:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        """
        return {
            "crew_members": {crew_id: crew.to_dict() for crew_id, crew in self.crew_members.items()},
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'CrewManagementSystem':
        ...
        system.station_assignments = data.get("station_assignments", {station: [] for station in STATION_TYPES})
