...
def main():
    ...
    item_details = {
        "iron_ore": {"type": "resource", "description": "Common metal ore used in basic construction"},
        "copper_ore": {"type": "resource", "description": "Conductive metal ore used in electronics"},
        "titanium_ore": {"type": "resource", "description": "Strong, lightweight metal ore for advanced construction"},
        "hydrogen_gas": {"type": "resource", "description": "Common fuel source for engines and reactors"},
        "oxygen_gas": {"type": "resource", "description": "Essential for life support systems"},
        "carbon_material": {"type": "resource", "description": "Versatile material for various applications"},
        "silicon_material": {"type": "resource", "description": "Key component in computer systems"},
        "laser_weapon_mk1": {"type": "equipment", "description": "Basic laser weapon system"},
        "shield_generator_basic": {"type": "equipment", "description": "Standard shield generator"},
        "engine_booster": {"type": "equipment", "description": "Increases ship speed and maneuverability"},
        "repair_kit": {"type": "misc", "description": "Used to repair ship damage"},
        "medical_supplies": {"type": "misc", "description": "Basic medical supplies for the crew"},
        "rare_artifact_alpha": {"type": "rare", "description": "Mysterious alien artifact of unknown origin"},
        "rare_crystal_fragment": {"type": "rare", "description": "Fragment of a rare energy crystal"},
        "quest_item_distress_beacon": {"type": "quest", "description": "Distress beacon from a stranded ship"},
        "quest_item_ancient_data_core": {"type": "quest", "description": "Ancient data core containing valuable information"},
        "fuel_cell": {"type": "resource", "description": "Standardized fuel cell for various systems"},
        "power_converter": {"type": "equipment", "description": "Converts power between different systems"},
        "navigation_module": {"type": "equipment", "description": "Advanced navigation system"},
        "scanner_upgrade": {"type": "equipment", "description": "Enhances scanner range and accuracy"}
    }
    ...
    while running:
        ...
        if current_time - last_update >= 5.0:
            ...
            if random.random() < 0.3:
                new_items = [
                    "platinum_ore", "gold_ore", "uranium_ore", 
                    "helium_gas", "nitrogen_gas", 
                    "laser_weapon_mk2", "shield_generator_advanced",
                    "rare_artifact_beta", "quest_item_encrypted_message"
                ]
                ...
                if new_item not in inventory:
                    ...
                    if new_item not in item_details:
                        item_type = "resource"
                        if "weapon" in new_item or "shield" in new_item or "generator" in new_item:
                            item_type = "equipment"
