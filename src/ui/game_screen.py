...
class ASCIIGameScreen:
    ...
    def _initialize_layout(self) -> None:
        ...
        footer_rect = pygame.Rect(
            0,
            header_height + main_content_height,
            screen_width,
            footer_height
        )
        self.components["footer"] = ASCIIPanel(
            footer_rect,
            style=self.style
        )
    ...
    def update(self, player_position=None, resources=None, health=None, energy=None) -> None:
    ...
    def handle_event(self, event: pygame.event.Event) -> bool:
        ...
        if self.active_modal and self.active_modal in self.components and self.components[self.active_modal].handle_event(event):
            return True
