...
class TestASCIIBoxEventIntegration(unittest.TestCase):
    ...
    def test_add_hover_handlers(self):
        ...
        result = add_hover_handlers(
            self.box,
            self.hover_enter_handler,
            self.hover_leave_handler
        )
    ...
    def test_handle_mouse_events(self):
        ...
        for i, box in enumerate(boxes):
            ...
            box.handle_mouse_event = MagicMock(return_value=i == 1)  # Only box 1 handles
        ...
        for box in boxes:
            box.handle_mouse_event.assert_called_once_with("click", mouse_pos, char_size)
