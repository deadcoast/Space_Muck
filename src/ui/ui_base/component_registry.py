...
class ComponentRegistry:
    ...
    def register(self, component: UIElement, component_id: Optional[str] = None) -> str:
        ...
        try:
            ...
            if self.on_component_registered:
                try:
                    self.on_component_registered(component_id, component.__class__.__name__)
    ...
    def set_parent_child_relationship(
    ...
    def _cleanup_component(self, component_id: str) -> None:
        ...
        try:
            if component_id in self._components:
                logging.debug(f"Cleaning up component {component_id} via weak reference")
                self.unregister(component_id)
        except Exception as e:
