...
class UIEventSystem:
    ...
    def __init__(self):
        ...
        self._handlers: Dict[
            UIEventType, Dict[str, List[Callable[[UIEventData], None]]]
        ] = {}
        ...
        self._event_counts: Dict[UIEventType, int] = {
            event_type: 0 for event_type in UIEventType
        }
    ...
    def unsubscribe(
        ...
        try:
            if (
                ...
                has_handlers = any(
                    component_id in event_handlers
    ...
    def emit(
        self, event_type: UIEventType, source_id: str, data: Dict[str, Any]
    ) -> None:
        """
        Emit a UI event.
    ...
    def _notify_handlers(self, event: UIEventData) -> None:
        ...
        try:
            if (
                event.type in self._handlers
                and event.source_id in self._handlers[event.type]
            ):
    ...
    def _bubble_event(self, event: UIEventData) -> None:
        ...
        try:
            ...
            while (
                current_id in self._component_parents and not event.propagation_stopped
            ):
    ...
    def clear_component(self, component_id: str) -> None:
        ...
        try:
            ...
            children_to_remove = [
                child_id
                for child_id, parent_id in self._component_parents.items()
            ...
            data = {"component_id": component_id, "timestamp": time.time()}
