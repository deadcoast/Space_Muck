...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Comprehensive GPU Benchmarking for Space Muck"
    )
    parser.add_argument(
        "--output-dir",
        type=str,
    ...
    if args.benchmark == "all":
        ...
        ca_results = benchmark_cellular_automaton(
            grid_sizes=args.small_grid_sizes, iterations=5, repetitions=args.repetitions
        )
        ...
        noise_results = benchmark_noise_generation(
            grid_sizes=args.small_grid_sizes, octaves=4, repetitions=args.repetitions
        )
        ...
        value_results = benchmark_value_generation(
            grid_sizes=args.small_grid_sizes, repetitions=args.repetitions
        )
        ...
        memory_results = benchmark_memory_transfer(
            data_sizes=args.large_data_sizes, repetitions=args.repetitions
        )
