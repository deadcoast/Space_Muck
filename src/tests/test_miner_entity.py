...
class TestMinerEntity(unittest.TestCase):
    ...
    def _test_trait_genome(self, trait, expected_values):
        ...
        for key, value in expected_values.items():
            self.assertEqual(genome[key], value, 
                             f"Trait {trait} should have {key}={value}")
    ...
    def test_process_minerals(self):
        ...
        self._process_minerals_handler(
            minerals,
            expected_fed=True,
            expected_population_change=True
        )
        ...
        self._process_minerals_handler(
            {},
            expected_fed=False,
            expected_population_change=False
        )
    ...
    def test_apply_mutations(self):
        ...
        self.assertEqual(self.miner.genome['expansion_drive'], 2.0)  # Clamped to max 2.0
    ...
    def test_calculate_resource_density(self):
        ...
        self._behavior_handler(
            behavior_probabilities, field
        )
