...
class ConverterRegistry:
    ...
    def _create_default_recipes(self):
        ...
        recipes = [
            ...
            Recipe(
                ...
                inputs={
                    ResourceType.ORGANIC_COMPOUND: 2,
                    ResourceType.RARE_EARTH: 1
                },
    ...
    def get_compatible_recipes(self, converter: Converter) -> List[Recipe]:
        ...
        """
        return [recipe for recipe in self.recipes.values() if recipe.is_compatible_with(converter)]
    ...
    def get_converters_by_type(self, converter_type: ConverterType) -> List[Converter]:
        ...
        """
        return [converter for converter in self.converters.values() if converter.type == converter_type]
    ...
    def get_converters_for_recipe(self, recipe: Recipe) -> List[Converter]:
        ...
        """
        return [
            converter for converter in self.converters.values() 
    ...
    def get_optimization_suggestions(self, converter: Converter) -> List[OptimizationSuggestion]:
        """
        ...
        suggestions.append(
            OptimizationSuggestion(
                description="Use higher quality resources",
                potential_gain=0.08
            )
        )
        ...
        suggestions.append(
            OptimizationSuggestion(
                description="Address nearby hazards",
                potential_gain=0.05
            )
        )
