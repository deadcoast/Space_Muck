...
class ModuleContext:
    ...
    def initialize_module(self, module_id: str) -> bool:
        ...
        self._record_state_change(module_id, ModuleState.INITIALIZING, ModuleState.ACTIVE)
    ...
    def _attempt_recovery(self, module_id: str) -> None:
        ...
        if self.initialize_module(module_id):
            ...
            module.state = ModuleState.ERROR
            self._record_state_change(module_id, ModuleState.RECOVERING, ModuleState.ERROR)
            logging.error(f"Failed to recover module {module_id}")

    def _record_state_change(
        self,
        module_id: str,
        old_state: Optional[ModuleState],
